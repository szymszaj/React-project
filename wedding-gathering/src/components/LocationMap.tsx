...
const LocationMap = () => {
  ...
  useEffect(() => {
    if (isVisible && iframeRef.current) {
      // Load Google Maps iframe once section is visible
      iframeRef.current.src = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9774.968355308895!2d21.01213687424931!3d52.232430241349!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x471ecc8c92692e49%3A0xc5c7a2e24ce6fca2!2sWarsaw%2C%20Poland!5e0!3m2!1sen!2sus!4v1688475546321!5m2!1sen!2sus";
      ...
      <div className="container mx-auto">
        <div className={`text-center mb-16 ${isVisible ? 'animate-reveal' : 'opacity-0'}`}>
          ...
          <p className="font-serif text-wedding-accent max-w-2xl mx-auto">
            Szczegółowe informacje dotyczące lokalizacji ceremonii oraz przyjęcia weselnego.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-2">
            <div className={`rounded-2xl overflow-hidden shadow-subtle h-96 relative ${isVisible ? 'animate-reveal' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
              {!mapLoaded && (
          ...
          <div className={`space-y-8 ${isVisible ? 'animate-reveal' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
            ...
            <div className="neo-morphism p-6 rounded-2xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-serif text-wedding-accent">
                    <a href="tel:+48123456789" className="hover:text-wedding-dark transition-colors">
                      +48 123 456 789
                    </a>
                  </p>
                </div>
            ...
            <div className="neo-morphism p-6 rounded-2xl">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="font-serif text-wedding-accent">
                    <a href="mailto:kontakt@wesele.pl" className="hover:text-wedding-dark transition-colors">
                      kontakt@wesele.pl
                    </a>
                  </p>
                </div>
