      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="font-serif text-wedding-accent max-w-2xl mx-auto">
            Mamy zaszczyt zaprosić Was do wspólnego świętowania naszego
            wyjątkowego dnia.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Ceremony */}
          <div
            className={`neo-morphism p-8 rounded-2xl transition-all duration-500 delay-100 ${
              isVisible ? "animate-reveal" : "opacity-0"
            }`}
          >
            ...
            <div className="space-y-4 text-center font-serif">
              <p className="text-wedding-accent">12 Września 2024</p>
              <p className="text-wedding-accent">14:00 - 15:30</p>
          ...
          {/* Reception */}
          <div
            className={`neo-morphism p-8 rounded-2xl transition-all duration-500 delay-200 ${
              isVisible ? "animate-reveal" : "opacity-0"
            }`}
          >
            <div className="w-16 h-16 rounded-full neo-morphism flex items-center justify-center mb-6 mx-auto">
            ...
            <div className="space-y-4 text-center font-serif">
              <p className="text-wedding-accent">12 Września 2024</p>
              <p className="text-wedding-accent">16:00 - 4:00</p>
              <p className="text-wedding-accent">
                Hotel Panorama
                <br />
          ...
          {/* Accommodation */}
          <div
            className={`neo-morphism p-8 rounded-2xl transition-all duration-500 delay-300 ${
              isVisible ? "animate-reveal" : "opacity-0"
            }`}
          >
            <div className="w-16 h-16 rounded-full neo-morphism flex items-center justify-center mb-6 mx-auto">
            ...
            <div className="space-y-4 text-center font-serif">
              <p className="text-wedding-accent">Hotel Panorama</p>
              <p className="text-wedding-accent">
                Rezerwacja do 1 Sierpnia 2024
              </p>
              <p className="text-wedding-accent">
                Kod zniżkowy: WESELE2024
                <br />
                Tel: +48 123 456 789
              </p>
            </div>
