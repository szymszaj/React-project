      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="font-serif text-wedding-accent max-w-2xl mx-auto">
            Najważniejsze momenty naszej wspólnej drogi, które doprowadziły nas
                  ...
                  >
                    ...
                    >
                      ...
                      <CollapsibleContent className="mt-4">
                        <p className="font-serif text-base text-wedding-accent">
                          {tile.content}
                        </p>
                      </CollapsibleContent>
                    </div>
